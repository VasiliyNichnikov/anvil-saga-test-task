...
namespace Player
{
    ...
    public class PlayerEngine : MonoBehaviour
    {
        ...
        [SerializeField][Range(1, 200)] private float _moveSpeed;
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawSphere(new Vector3(_engine.TargetPosition.x, _engine.TargetPosition.y, 0), 1f);
                
            Gizmos.color = Color.black;
            Gizmos.DrawSphere(new Vector3(_thisTransform.position.x, _thisTransform.position.y, 0), 1f);
